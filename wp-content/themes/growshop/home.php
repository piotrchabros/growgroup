...
$home_page_title  = $posts_page_id ? get_the_title( $posts_page_id ) : __( 'Blog', 'growshop' );
$home_description = $posts_page_id ? get_post_field( 'post_excerpt', $posts_page_id ) : '';
?>
            ...
            <div class="banner-layout">
                <div class="d-flex flex-column text-center align-items-center gspace-2">
                    <h2 class="title-heading animate-box animated animate__animated" data-animate="animate__fadeInRight">
                        <?php echo esc_html( $home_page_title ); ?>
                    </h2>
                    <nav class="breadcrumb">
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="gspace-2">Home</a>
                        <span class="separator-link">/</span>
                        <p class="current-page"><?php echo esc_html( $home_page_title ); ?></p>
                    </nav>
                </div>
    ...
    <div class="section">
        <div class="hero-container">
            <div class="d-flex flex-column gspace-5">
                    ...
                    <div class="col col-xl-8 ps-0 pe-0">
                        <div class="d-flex flex-column gspace-2 animate-box animated fast animate__animated" data-animate="animate__fadeInLeft">
                            <div class="sub-heading">
                                ...
                                <span><?php esc_html_e( 'Insights & Trends', 'growshop' ); ?></span>
                            </div>
                            <h2 class="title-heading"><?php echo esc_html( $home_page_title ); ?></h2>
                        </div>
                    </div>
                    <div class="col col-xl-4 ps-0 pe-0">
                        <div class="d-flex flex-column gspace-2 justify-content-end h-100 animate-box animated animate__animated" data-animate="animate__fadeInRight">
                            <?php if ( $home_description ) : ?>
                                <p><?php echo esc_html( $home_description ); ?></p>
                            <?php else : ?>
                                <p><?php esc_html_e( 'Poznaj artykuly o marketingu, sprzedazy i skalowaniu biznesu.', 'growshop' ); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <?php else : ?>
                    <p><?php esc_html_e( 'Brak wpisow do wyswietlenia.', 'growshop' ); ?></p>
                <?php endif; ?>
            </div>
        </div>
    </div>
