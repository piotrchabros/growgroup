...
function initBannerVideo() {
    ...
    function setYoutubeSize() {
        var $videoBg = $('#banner-video-background');
        var $container = $videoBg.closest('.banner-video-container');
        if (!$container.length) $container = $('.banner-video-container:visible');
    ...
    window.setYoutubeSize = setYoutubeSize;
...
function initThemeSwitch() {
    ...
    const updateLogos = () => {
        ...
        if (lightMode) {
            ...
            siteLogos.attr('src', 'image/growshop-logo-dark.png');
            ...
            siteLogos.attr('src', 'image/growshop-logo-light.png');
